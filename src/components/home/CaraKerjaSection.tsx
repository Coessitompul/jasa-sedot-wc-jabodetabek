...
const steps = [
  {
    icon: MessageCircle,
    title: "Hubungi Kami",
    desc: "Hubungi via WhatsApp atau telepon. Ceritakan masalah dan lokasi Anda.",
  },
  {
    icon: MapPin,
    title: "Survei Lokasi",
    desc: "Tim kami datang untuk survei dan memberikan estimasi harga yang transparan.",
  },
  {
    icon: Wrench,
    title: "Pengerjaan",
    desc: "Proses sedot dilakukan dengan peralatan modern dan prosedur higienis.",
  },
  {
    icon: BadgeCheck,
    title: "Selesai & Garansi",
    desc: "Pekerjaan selesai bersih. Kami berikan garansi kepuasan untuk setiap layanan.",
  },
]
          ...
          {steps.map((step, i) => {
            ...
            return (
              <div key={step.title} className="relative z-10 flex flex-col items-center text-center">
                {/* Number — top-center semua ukuran */}
                ...
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-navy flex items-center justify-center mb-3 md:mb-5 shadow-md">
